...
Local $funame, $cntrlname
$cntrlname =  "Web - " & $testCaseProjectName & "/WebContent/" & $testCaseJspName & " - Eclipse"
...
Local $string =  ControlGetText("Web - MyHelloWorld/WebContent/newsession.jsp - Eclipse","","[CLASS:SysLink]")
